...
- Conversion funnel analysis (repeat vs single customers)  
- Interactive filters for metrics, gateways, and regions  
...
├── data/
│   └── shopify_sales_data.xlsm
├── dashboard/
│   └── shopify_sales_funnel.pbix
├── images/
...
4. Explore insights using interactive visuals and slicers
